...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get appTitle => 'ఉజావన్ - స్మార్ట్ వ్యవసాయం';

  @override
  String get chatbotTitle => 'ఏఐ చాట్‌బాట్';

  @override
  String get forumTitle => 'ఫోరం';

  @override
  String get soilTitle => 'మట్టి డేటా';

  @override
  String get chatbotPlaceholder => 'చాట్‌బాట్ సంభాషణ ఇక్కడ కనిపిస్తుంది.';

  @override
  String get forumPlaceholder => 'ఫోరం ఫీచర్ త్వరలో వస్తోంది.';

  @override
  String get soilPlaceholder => 'మట్టి సెన్సార్ ఇంటిగ్రేషన్ త్వరలో వస్తోంది.';
